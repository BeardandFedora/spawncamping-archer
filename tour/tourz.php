...
<html lang="en">
<head>
  <title>AppsFreedom Prototype App :: Tour</title>
  <link href="/plugins/custom_scroller/css/CustomScrollbar.css" rel="stylesheet">

  <?php include( $_SERVER['DOCUMENT_ROOT'].'/includes/head.php'); ?>
</head>
<body data-spy="scroll" data-target="#tour-scrollby" data-offset="0" class="tour">
  <?php include( $_SERVER['DOCUMENT_ROOT'].'/includes/nav.php'); ?>
  
  <section id="build-fast" class="hero">
    <div class="jumbotron container text-center">
      <div class="tour-header">
        <img src="/img/tour/platform-tour-hero-header-lg.png" alt="" class="visible-md-block visible-lg-block center-block img-responsive" />
        <img src="/img/tour/platform-tour-hero-header-sm.png" alt="" class="visible-xs-block visible-sm-block center-block" />
      </div>
      ...
      <div class="container">
        <div class="carousel-inner">
          <div class="item active">
            <div class="row">
              <div class="col-md-5">
                <img src="/img/tour/slides/1_launch_faster/image_01.png" class="img-responsive center-block" alt="Model-Driven Platform">
              </div>
              <div class="col-md-7">
                ...
                <div class="row">
                  <div class="col-xs-6 clearfix">
                    <div class="download-items">
                      <a class="download-item-link" href="#">
                        <img class="avatar size42" src="/img/doc_types/blog.png">
                  ...
                  <div class="col-xs-6">
                    <div class="download-items">
                      <a class="download-item-link" href="#">
                        <img class="avatar size42" src="/img/doc_types/pdf.png">
          ...
          <div class="item">
            <div class="row">
              <div class="col-md-5">
                <img src="/img/tour/slides/1_launch_faster/image_02.png" class="img-responsive center-block" alt="Empower Citizen Developers">
              </div>
              <div class="col-md-7">
          ...
          <div class="item">
            <div class="row">
              <div class="col-md-5">
                <img src="/img/tour/slides/1_launch_faster/image_03.png" class="img-responsive center-block" alt="Build Once, Run Anywhere">
              </div>
              <div class="col-md-7">
          ...
          <div class="item">
            <div class="row">
              <div class="col-md-5">
                <img src="/img/tour/slides/1_launch_faster/image_04.png" class="img-responsive center-block" alt="Visual Development">
              </div>
              <div class="col-md-7">
    ...
    <div class="text-center hero-cta">
      <a type="button" href="/testdrive" class="btn button">Take A Test Drive <span class="btn-arrow gray"></span></a> <!-- <span>or visit the <a href="#"><u>Learning Center</u></span></a> -->
    </div>
  </section>
  ...
  <section id="fully-loaded" class="hero bg-gray">
    <div class="jumbotron container text-center">
      <!-- <img src="/img/tour/fully-loaded-bg.png" class="img-responsive" alt="" /> -->
      ...
      <div class="container">
        <div class="carousel-inner">
          <div class="item active">
            <div class="row">
              <div class="col-md-5">
                <img src="/img/tour/slides/2_accelerate_time/image_01.png" class="img-responsive center-block" alt="Multi-Language">
              </div>
              <div class="col-md-7">
          ...
          <div class="item">
            <div class="row">
              <div class="col-md-5">
                <img src="/img/tour/slides/2_accelerate_time/image_02.png" class="img-responsive center-block" alt="Mobile Analytics">
              </div>
              <div class="col-md-7">
          ...
          <div class="item">
            <div class="row">
              <div class="col-md-5">
                <img src="/img/tour/slides/2_accelerate_time/image_03.png" class="img-responsive center-block" alt="Online/Offline">
              </div>
              <div class="col-md-7">
          ...
          <div class="item">
            <div class="row">
              <div class="col-md-5">
                <img src="/img/tour/slides/2_accelerate_time/image_04.png" class="img-responsive center-block" alt="Hybrid / Web / Native*">
              </div>
              <div class="col-md-7">
                <h3>Hybrid / Web / Native*</h3>
                <p>Deploy hybrid, HTML5 or native apps - your choice. HTML5, iOS, Android, Blackberry, Windows + hybrid Apps: we can do it all.</p>
              </div>
            </div>
          </div>
          <div class="item">
            <div class="row">
              <div class="col-md-5">
                <img src="/img/tour/slides/2_accelerate_time/image_05.png" class="img-responsive center-block" alt="End-User Collaboration">
              </div>
              <div class="col-md-7">
      ...
      <div class="container">
        <div class="carousel-inner">
          <div class="item active">
            <div class="row">
              <div class="col-md-5">
                <img src="/img/tour/slides/3_integrate/image_01.png" class="img-responsive center-block" alt="Native Integrations">
              </div>
              <div class="col-md-7">
                <h3>Native Integrations</h3>
                <p>Integrate to any SAP assets with no dependency patch or versions.</p>
              </div>
            </div>
          </div>
          <div class="item">
            <div class="row">
              <div class="col-md-5">
                <img src="/img/tour/slides/3_integrate/image_02.png" class="img-responsive center-block" alt="Real-time Integration">
              </div>
              <div class="col-md-7">
          ...
          <div class="item">
            <div class="row">
              <div class="col-md-5">
                <img src="/img/tour/slides/3_integrate/image_03.png" class="img-responsive center-block" alt="Composite Mobile Apps">
              </div>
              <div class="col-md-7">
          ...
          <div class="item">
            <div class="row">
              <div class="col-md-5">
                <img src="/img/tour/slides/3_integrate/image_04.png" class="img-responsive center-block" alt="Back-end-as-a-Service (BaaS)">
              </div>
              <div class="col-md-7">
                <h3>Back-end-as-a-Service (BaaS)</h3>
                <p>Integrate to multiple systems and leverage business and integration logic with Back-end-as-a-Service (BaaS) capabilities.</p>
              </div>
            </div>
          </div>
        </div>
        <div class="carousel-indicators-outer clearfix visible-lg">
          ...
          <div class="carousel-options col-lg-10">
            <ul class="carousel-indicators clearfix">
              ...
              <li data-target="#carousel-integrate" data-slide-to="3">Back-end-as-a-Service (BaaS)</li>
            </ul>
          </div>
  ...
  <section id="full-lifecycle" class="hero bg-md-blue">
      ...
      <div class="container">
        <div class="carousel-inner">
          <div class="item active">
            <div class="row">
              <div class="col-md-5">
                <img src="/img/tour/slides/4_app_lifecycle/image_01.png" class="img-responsive center-block" alt="Build, Deploy, & Manage Apps">
              </div>
              <div class="col-md-7">
          ...
          <div class="item">
            <div class="row">
              <div class="col-md-5">
                <img src="/img/tour/slides/4_app_lifecycle/image_02.png" class="img-responsive center-block" alt="Centralized App Administration">
              </div>
              <div class="col-md-7">
          ...
          <div class="item">
            <div class="row">
              <div class="col-md-5">
                <img src="/img/tour/slides/4_app_lifecycle/image_03.png" class="img-responsive center-block" alt="Corporate App Library">
              </div>
              <div class="col-md-7">
                <h3>Corporate App Library</h3>
                <p>Deploy using a corporate app library or leverage your MDM deployment capabilities.</p>
              </div>
            </div>
          </div>
          <div class="item">
            <div class="row">
              <div class="col-md-5">
                <img src="/img/tour/slides/4_app_lifecycle/image_04.png" class="img-responsive center-block" alt="App Metrics">
              </div>
              <div class="col-md-7">
                <h3>App Metrics</h3>
    ...
    <div class="text-center hero-cta">
      <a type="button" href="/testdrive" class="btn button">Take A Test Drive <span class="btn-arrow"></span></a> <!-- <span>or visit the <a href="#"><u>Learning Center</u></span></a> -->
    </div>
  </section>

  <section id="scalable" class="hero bg-md-blue">
    <div class="jumbotron container text-center">
      <!-- <img src="/img/tour/scalability-bg.png" class="img-responsive" alt="" /> -->
      ...
      <div class="container">
        <div class="carousel-inner">
          <div class="item active">
            <div class="row">
              <div class="col-md-5">
                <img src="/img/tour/slides/5_scalability/image_01.png" class="img-responsive center-block" alt="Multi-tenant infrastructure">
              </div>
              <div class="col-md-7">
          ...
          <div class="item">
            <div class="row">
              <div class="col-md-5">
                <img src="/img/tour/slides/5_scalability/image_02.png" class="img-responsive center-block" alt="Distributed Architecture">
              </div>
              <div class="col-md-7">
          ...
          <div class="item">
            <div class="row">
              <div class="col-md-5">
                <img src="/img/tour/slides/5_scalability/image_03.png" class="img-responsive center-block" alt="Cloud Database">
              </div>
              <div class="col-md-7">
          ...
          <div class="item">
            <div class="row">
              <div class="col-md-5">
                <img src="/img/tour/slides/5_scalability/image_04.png" class="img-responsive center-block" alt="Private Cloud or On-Premise">
              </div>
              <div class="col-md-7">
          ...
          <div class="item">
            <div class="row">
              <div class="col-md-5">
                <img src="/img/tour/slides/5_scalability/image_05.png" class="img-responsive center-block" alt="High Availability">
              </div>
              <div class="col-md-7">
        ...
        <div class="carousel-indicators-outer clearfix visible-lg">
          ...
          <div class="carousel-options col-lg-10">
            <ul class="carousel-indicators clearfix">
              ...
              <li data-target="#carousel-scalable" data-slide-to="3">Private Cloud or On-Premise Deployment</li>
      ...
      <div class="container">
        <div class="carousel-inner">
          <div class="item active">
            <div class="row">
              <div class="col-md-5">
                <img src="/img/tour/slides/6_secure/image_01.png" class="img-responsive center-block" alt="Secure Communication">
              </div>
              <div class="col-md-7">
          ...
          <div class="item">
            <div class="row">
              <div class="col-md-5">
                <img src="/img/tour/slides/6_secure/image_02.png" class="img-responsive center-block" alt="Authentication">
              </div>
              <div class="col-md-7">
          ...
          <div class="item">
            <div class="row">
              <div class="col-md-5">
                <img src="/img/tour/slides/6_secure/image_03.png" class="img-responsive center-block" alt="Secure & Independent Tenant">
              </div>
              <div class="col-md-7">
          ...
          <div class="item">
            <div class="row">
              <div class="col-md-5">
                <img src="/img/tour/slides/6_secure/image_04.png" class="img-responsive center-block" alt="User Management">
              </div>
              <div class="col-md-7">
          ...
          <div class="item">
            <div class="row">
              <div class="col-md-5">
                <img src="/img/tour/slides/6_secure/image_05.png" class="img-responsive center-block" alt="Transient">
              </div>
              <div class="col-md-7">
                <h3>Transient</h3>
          ...
          <div class="item">
            <div class="row">
              <div class="col-md-5">
                <img src="/img/tour/slides/6_secure/image_06.png" class="img-responsive center-block" alt="Controlled IP">
              </div>
              <div class="col-md-7">
                <h3>Controlled IP</h3>
          ...
          <div class="item">
            <div class="row">
              <div class="col-md-5">
                <img src="/img/tour/slides/6_secure/image_07.png" class="img-responsive center-block" alt="Mobile Device Management">
              </div>
              <div class="col-md-7">
        ...
        <div class="carousel-indicators-outer clearfix visible-lg">
          ...
          <div class="carousel-options col-lg-10">
            <ul class="carousel-indicators clearfix">
              ...
              <li data-target="#carousel-secure" data-slide-to="4">Transient</li>
  ...
  <section id="open-platform" class="hero">
    <div class="jumbotron container text-center">
      <!-- <img src="/img/tour/open-platform-bg.png" class="img-responsive" alt="" /> -->
      ...
      <div class="container">
        <div class="carousel-inner">
          <div class="item active">
            <div class="row">
              <div class="col-md-5">
                <img src="/img/tour/slides/7_open/image_01.png" class="img-responsive center-block" alt="Model">
              </div>
              <div class="col-md-7">
          ...
          <div class="item">
            <div class="row">
              <div class="col-md-5">
                <img src="/img/tour/slides/7_open/image_02.png" class="img-responsive center-block" alt="Platform Extensions">
              </div>
              <div class="col-md-7">
          ...
          <div class="item">
            <div class="row">
              <div class="col-md-5">
                <img src="/img/tour/slides/7_open/image_03.png" class="img-responsive center-block" alt="Take your Apps with you">
              </div>
              <div class="col-md-7">
        ...
        <div class="carousel-indicators-outer clearfix visible-lg">
          ...
          <div class="carousel-options col-lg-8">
            <ul class="carousel-indicators clearfix">
  ...
  <script src="/js/custom.scrollby.js"></script>
