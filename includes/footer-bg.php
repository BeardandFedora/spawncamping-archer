<footer class="bg-md-blue">
	<div class="footer-logo">
		<a href="/" class="btn btn-link btn-xs">
			<img src="/img/logo-footer-big.png" alt="" />
		</a>
	</div>
	<nav role="navigation">
		<div class="container">
			<div class="row">
				<div class="col-lg-3 visible-lg footer-bg">
				...
				<div class="col-lg-2">
					...
					<!-- <dl>
						<dt>Resources</dt>
						<dd><a href="#">Learning Center</a></dd>
						<dd><a href="#">Blog</a></dd>
					</dl> -->
				</div>
				<div class="col-lg-2">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					...
					<!-- <small><a href="#">Terms, Privacy & Copyright Security</a></small> -->
				</div>
				<div class="col-md-6 cred">
					<small>Site by <a href="http://lean-labs.com/?utm_source=client&utm_medium=clientsite&utm_content=appsfreedom&utm_campaign=clientsite" target="_blank">LeanLabs</a></small>
				</div>
			</div>
		</div>
	</div>
