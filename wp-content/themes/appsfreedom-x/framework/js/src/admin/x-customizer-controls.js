...
jQuery(document).ready(function($) {
  ...
  xCustomizerText( $( '#customize-control-x_integrity_layout_site' ),                         false,                                  'The AppsFreedom Integrity theme is a beautiful design with a more traditional layout, yet with plenty of modern touches. Custom designed by Lean Labs using LeanStack X.' );
  xCustomizerText( $( '#customize-control-x_integrity_design' ),                              'Design Options',                       'The greatness of LeanStack\'s design approach is in its simplicity. The look and feel of your site will change dramatically based on the choices selected for a couple options.' );
  ...
  xCustomizerText( $( '#customize-control-x_integrity_blog_header_enable' ),                  'Learning Center Options',                         'Enabling the Learning Center header will turn on the area above your posts on the index page that contains your title and subtitle. Disabling it will result in more content being visible above the fold.' );
  ...
  xCustomizerText( $( '#customize-control-x_renew_blog_title' ),                              'Learning Center Options',                         'The entry icon color is for the post icons to the left of each title. Selecting "Creative" under the "Entry Icon Position" setting will allow you to align your entry icons in a different manner on your posts index page when "Content Left, Sidebar Right" or "Fullwidth" are selected as your "Content Layout" and when the Learning Center "Style" is set to "Standard." This feature is intended to be paired with a "Boxed" layout.' );
  ...
  xCustomizerText( $( '#customize-control-x_icon_post_standard_colors_enable' ),              'Learning Center Options',                         'Set unique colors for each Learning Center post type if you so desire. You can enable or disable any combination of colors you want to fit your design style.' );
  ...
  xCustomizerText( $( '#customize-control-x_ethos_post_slider_blog_enable' ),                 'Post Slider &ndash; Learning Center',             'The Learning Center "Post or Article Slider" is located at the top of the posts index page, which allows you to showcase your posts in various formats. If "Featured" is chosen as a display option, a text input will appear to enter in the IDs of the posts you would like to showcase. This input accepts a list of numeric IDs separated by a comma (e.g. 14, 1, 817).' );
  ...
  xCustomizerText( $( '#customize-control-x_ethos_filterable_index_enable' ),                 'Learning Center Options',                         'Enabling the filterable index will bypass the standard output of your Learning Center page, allowing you to specify categories to highlight. Upon selecting this option, a text input will appear to enter in the IDs of the categories you would like to showcase. This input accepts a list of numeric IDs separated by a comma (e.g. 14, 1, 817).' );
  ...
  xCustomizerText( $( '#customize-control-x_custom_fonts' ),                                  false,                                  'LeanStack provides you with full control over your site\'s typography. Remember to check the box for "Enable Custom Fonts" to set your own individual fonts for headings, body copy, et cetera.' );
  ...
  xCustomizerText( $( '#customize-control-x_footer_widget_areas' ),                           false,                                  'Easily adjust your site\'s footer by setting your widget areas to the specific number desired and turning on or off various parts as needed. You\'re never forced to use a layout you don\'t need with LeanStack.' );
  ...
  xCustomizerText( $( '#customize-control-x_blog_style' ),                                    false,                                  'Adjust the style and layout of the Learning Center using the settings below. This will only affect the posts index page of the Learning Center and will not alter any archive or search results pages. The "Layout" option allows you to keep your sidebar on your posts index page if you have already selected "Content Left, Sidebar Right" or "Sidebar Left, Content Right" for you "Content Layout" option, or remove the sidebar completely if desired.' );
  ...
  xCustomizerText( $( '#customize-control-x_custom_portfolio_slug' ),                         false,                                  'Setting your custom App slug allows you to create a unique URL structure for your archive pages that suits your needs. When you update it, remember to save your Permalinks again to avoid any potential errors.' );
