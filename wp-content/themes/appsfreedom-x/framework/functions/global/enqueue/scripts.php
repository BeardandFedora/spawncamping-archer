...
// -----------------------------------------------------------------------------
// Enqueue all scripts for LeanStack.
// =============================================================================
...
if ( ! function_exists( 'x_enqueue_site_scripts' ) ) :
  function x_enqueue_site_scripts() {
    ...
    wp_register_script( 'x-bootstrap',           X_TEMPLATE_URL . '/framework/js/dist/site/bootstrap.min.js',           array( 'jquery' ), NULL, true );
    wp_register_script( 'x-jansy-bootstrap',     X_TEMPLATE_URL . '/framework/js/dist/site/bootstrap.jansy.min.js',     array( 'jquery' ), NULL, true );
    wp_register_script( 'x-af-custom',           X_TEMPLATE_URL . '/framework/js/dist/site/custom.js',                  array( 'jquery' ), NULL, true );
    wp_register_script( 'x-custom-scroller',     X_TEMPLATE_URL . '/framework/js/dist/plugins/custom_scroller/js/CustomScrollbar.concat.min.js',           array( 'jquery' ), NULL, true );
    wp_register_script( 'x-tour',                X_TEMPLATE_URL . '/framework/js/dist/site/tour.js',                    array( 'jquery' ), NULL, true );
    ...
    wp_enqueue_script( 'x-bootstrap' );
    wp_enqueue_script( 'x-jansy-bootstrap' );
    wp_enqueue_script( 'x-af-custom' );
    wp_enqueue_script( 'x-custom-scroller' );
    wp_enqueue_script( 'x-tour' );
