...
if ( ! function_exists( 'x_enqueue_site_styles' ) ) :
  function x_enqueue_site_styles() {
    ...
    // Bootstrap
    // 
    wp_enqueue_style( 'x-boot', get_stylesheet_directory_uri() . '/framework/css/site/bootstrap/bootstrap.min.css', NULL, NULL, 'all' );

    // 
    // Custom Scrollbar
    // 
    wp_enqueue_style( 'x-scrollbar', get_stylesheet_directory_uri() . '/framework/js/dist/plugins/custom_scroller/css/CustomScrollbar.css', NULL, NULL, 'all' );
      
      
    //
    // AppsFreedom LeanStack X styles.
    //
    if ( is_child_theme() ) {
