  ...
  function x_register_theme_plugins() {
    ...
    $config = array(
      ...
      'strings'          => array(
        ...
        'notice_can_install_required'     => _n_noop( 'LeanStack requires the following plugin: %1$s.', 'LeanStack requires the following plugins: %1$s.' ),
        'notice_can_install_recommended'  => _n_noop( 'LeanStack recommends the following plugin: %1$s.', 'LeanStack recommends the following plugins: %1$s.' ),
        ...
        'notice_ask_to_update'            => _n_noop( 'The following plugin needs to be updated to its latest version to ensure maximum compatibility with LeanStack: %1$s.', 'The following plugins need to be updated to their latest version to ensure maximum compatibility with LeanStack: %1$s.' ),
