...
function x_customizer_add_tools() {
  ...
  if ( current_user_can( 'edit_theme_options' ) ) { ?>
    ...
    <div class="tool-box x-customizer">
      <h3 class="title">LeanStack &ndash; Customizer Tools</h3>
...
function x_customizer_import_tool() { ?>
  ...
  <div class="import-export-reset import">
    ...
    <form method="post" enctype="multipart/form-data">
      ...
      <p>Howdy! Upload your LeanStack Customizer Settings (LSCS) file and we&apos;ll import the options into this site.</p>
      <p>Choose a LSCS (.json) file to upload, then click "Upload File and Import."</p>
  ...
  ?>
    ...
    <div class="import-export-reset export">
      ...
      <form method="post">
        ...
        <p>This format, which we call LeanStack Customizer Settings or LSCS, will contain your Customizer settings for LeanStack.</p>
...
function x_customizer_reset_tool() { ?>
  ...
  <div class="import-export-reset reset">
    ...
    <form method="post">
      ...
      <p>When you click the button below WordPress will reset your LeanStack Customizer settings as if it were a brand new installation.</p>
