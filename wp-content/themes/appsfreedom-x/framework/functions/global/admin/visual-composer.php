...
// Alters the default functionality of the Visual Composer plugin and adds a of LeanStack language
// One of the benefits of LeanStack is the that there is a lot of inline help documentation added
//  for the benefit of the tens of thousands website's administrators, editors, designers, 
//  developers, system admins, authors, marketers, analysts, and owners. Just sayin'
// ==============================================================================================
    ...
    function x_visual_composer_map_shortcodes() {
      ...
      vc_map(
        array(
          ...
          'description' => __( 'Place a horizontal rule in the content', '__x__' ),
          'params'      => array(
            array(
              'param_name'  => 'id',
              'heading'     => __( 'ID', '__x__' ),
      ...
      vc_map(
        array(
          ...
          'icon'        => 'gap',
          'category'    => __( 'Structure', '__x__' ),
          'description' => __( 'Insert a vertical gap in the content', '__x__' ),
          'params'      => array(
            array(
              'param_name'  => 'size',
              'heading'     => __( 'Size', '__x__' ),
              'description' => __( 'Enter in the size of the gap. Pixels, ems, and percentages are all valid units of measurement.', '__x__' ),
              'type'        => 'textfield',
              'holder'      => 'div',
              'value'       => '1.313em'
            ),
      ...
      vc_map(
        array(
          ...
          'icon'        => 'clear',
          'category'    => __( 'Structure', '__x__' ),
          'description' => __( 'Clear floated elements in the content', '__x__' ),
          'params'      => array(
            array(
              'param_name'  => 'id',
              'heading'     => __( 'ID', '__x__' ),
      ...
      //         'description' => __( 'Enter the text.', '__x__' ),
      //         'type'        => 'textarea_html',
      //         'holder'      => 'div',
      //         'value'       => ''
      //       ),
      ...
      vc_map(
        array(
          ...
          'icon'        => 'blockquote',
          'category'    => __( 'Typography', '__x__' ),
          'description' => __( 'Include a blockquote in the content', '__x__' ),
          'params'      => array(
            array(
              'param_name'  => 'content',
              'heading'     => __( 'Text', '__x__' ),
      ...
      vc_map(
        array(
          ...
          'icon'        => 'pullquote',
          'category'    => __( 'Typography', '__x__' ),
          'description' => __( 'Include a pullquote in the content', '__x__' ),
          'params'      => array(
            array(
              'param_name'  => 'content',
              'heading'     => __( 'Text', '__x__' ),
        ...
        array(
          ...
          'params'      => array(
            ...
            array(
              ...
              'description' => __( 'Enter the heading of the alert.', '__x__' ),
              'type'        => 'textfield',
              'holder'      => 'div'
            ),
            array(
        ...
        array(
          ...
          'params'      => array(
            array(
              ...
              'description' => __( 'Switch to the "text" editor and do not place anything else here other than the &lsaquo;iframe&rsaquo; or &lsaquo;embed&rsaquo; code.', '__x__' ),
              'type'        => 'textarea_html',
              'holder'      => 'div',
              'value'       => ''
            ),
        ...
        array(
          ...
          'params'      => array(
            array(
              'param_name'  => 'heading',
              'heading'     => __( 'Heading', '__x__' ),
              'description' => __( 'Enter the heading of the skill bar.', '__x__' ),
              'type'        => 'textfield',
              'holder'      => 'div'
            ),
            array(
              ...
              'description' => __( 'Enter the percentage of the skill and be sure to include the percentage sign (i.e. 90%).', '__x__' ),
              'type'        => 'textfield',
              'holder'      => 'div'
            ),
            array(
      ...
      vc_map(
        array(
          ...
          'icon'        => 'code',
          'category'    => __( 'Typography', '__x__' ),
          'description' => __( 'Add a block of example code to the content', '__x__' ),
          'params'      => array(
            array(
              'param_name'  => 'content',
              'heading'     => __( 'Text', '__x__' ),
      ...
      vc_map(
        array(
          ...
          'description' => __( 'Add a clickable button to the content', '__x__' ),
          'params'      => array(
            array(
              'param_name'  => 'content',
              'heading'     => __( 'Text', '__x__' ),
            ...
            array(
              ...
              'description' => __( 'Select to make the button go fullwidth.', '__x__' ),
              'type'        => 'checkbox',
              'holder'      => 'div',
              'value'       => array(
                '' => 'true'
            ...
            array(
              ...
              'description' => __( 'Select to include a marketing circle around the button.', '__x__' ),
              'type'        => 'checkbox',
              'holder'      => 'div',
              'value'       => array(
                '' => 'true'
            ...
            array(
              ...
              'description' => __( 'Select if you are only using an icon in the button.', '__x__' ),
              'type'        => 'checkbox',
              'holder'      => 'div',
              'value'       => array(
                '' => 'true'
            ...
            array(
              ...
              'description' => __( 'Enter in the URL for button to link to.', '__x__' ),
              'type'        => 'textfield',
              'holder'      => 'div'
            ),
            array(
              ...
              'description' => __( 'Enter in the title attribute you want for the button (will also double as title for popover or tooltip if you have chosen to display one).', '__x__' ),
              'type'        => 'textfield',
              'holder'      => 'div'
            ),
            array(
              ...
              'description' => __( 'Select to open the button link in a new window.', '__x__' ),
              'type'        => 'checkbox',
              'holder'      => 'div',
              'value'       => array(
                '' => 'blank'
            ...
            array(
              ...
              'description' => __( 'Select whether or not to add a popover or tooltip to the button.', '__x__' ),
              'type'        => 'dropdown',
              'holder'      => 'div',
              'value'       => array(
                'None'    => 'none',
            ...
            array(
              ...
              'description' => __( 'Select where which popover or tooltip to appear.', '__x__' ),
              'type'        => 'dropdown',
              'holder'      => 'div',
              'value'       => array(
                'Top'    => 'top',
            ...
            array(
              ...
              'description' => __( 'Select what actions to trigger the popover or tooltip.', '__x__' ),
              'type'        => 'dropdown',
              'holder'      => 'div',
              'value'       => array(
                'Hover' => 'hover',
            ...
            array(
              ...
              'description' => __( 'Use this option to select a thumbnail for the lightbox thumbnail navigation or to set an image if you are linking out to a video.', '__x__' ),
              'type'        => 'attach_image',
              'holder'      => 'div'
            ),
            array(
      ...
      //     'icon'        => 'icon',
      //     'category'    => __( 'Typography', '__x__' ),
      //     'description' => __( 'Include a Font Awesome icon in the content', '__x__' ),
      //     'params'      => array(
      //       array(
      //         'param_name'  => 'type',
      //         'heading'     => __( 'Type', '__x__' ),
      //         'description' => __( 'Select the icon.', '__x__' ),
      //         'type'        => 'dropdown',
      //         'holder'      => 'div',
      ...
      vc_map(
        array(
          ...
          'description'     => __( 'Include a block grid container in the content', '__x__' ),
      ...
      vc_map(
        array(
          ...
          'category'        => __( 'Content', '__x__' ),
          'description'     => __( 'Include a block grid item in the block grid', '__x__' ),
      ...
      vc_map(
        array(
          ...
          'icon'        => 'image',
          'category'    => __( 'Media', '__x__' ),
          'description' => __( 'Include an image in the content', '__x__' ),
          'params'      => array(
            array(
              'param_name'  => 'type',
              'heading'     => __( 'Style', '__x__' ),
            ...
            array(
              ...
              'description' => __( 'Enter the image.', '__x__' ),
              'type'        => 'attach_image',
              'holder'      => 'div'
            ),
            array(
              ...
              'description' => __( 'Enter in the alt text for the image.', '__x__' ),
              'type'        => 'textfield',
              'holder'      => 'div'
            ),
            array(
              ...
              'description' => __( 'Select to wrap the image in an anchor tag.', '__x__' ),
              'type'        => 'checkbox',
              'holder'      => 'div',
              'value'       => array(
                '' => 'true'
            ...
            array(
              'param_name'  => 'href',
              'heading'     => __( 'Href', '__x__' ),
              'description' => __( 'Enter in a URL to link to. If using this image for a lightbox, enter the URL of the media here (e.g. YouTube embed URL, et cetera). Leave this field blank if to link to the image uploaded to the "Src" for the lightbox.', '__x__' ),
              'type'        => 'textfield',
              'holder'      => 'div'
            ),
            array(
              'param_name'  => 'title',
              'heading'     => __( 'Title', '__x__' ),
              'description' => __( 'Enter in the title attribute you want for the image (will also double as title for popover or tooltip if you have chosen to display one).', '__x__' ),
              'type'        => 'textfield',
              'holder'      => 'div'
            ),
            array(
              'param_name'  => 'target',
              'heading'     => __( 'Target', '__x__' ),
              'description' => __( 'Select to open the image link in a new window.', '__x__' ),
              'type'        => 'checkbox',
              'holder'      => 'div',
              'value'       => array(
                '' => 'blank'
            ...
            array(
              'param_name'  => 'info',
              'heading'     => __( 'Info', '__x__' ),
              'description' => __( 'Select whether or not to add a popover or tooltip to the image.', '__x__' ),
              'type'        => 'dropdown',
              'holder'      => 'div',
              'value'       => array(
                'None'    => 'none',
            ...
            array(
              'param_name'  => 'info_place',
              'heading'     => __( 'Info Placement', '__x__' ),
              'description' => __( 'Select where the popover or tooltip should appear.', '__x__' ),
              'type'        => 'dropdown',
              'holder'      => 'div',
              'value'       => array(
                'Top'    => 'top',
            ...
            array(
              'param_name'  => 'lightbox_thumb',
              'heading'     => __( 'Lightbox Thumbnail', '__x__' ),
              'description' => __( 'Use this option to select a different thumbnail for the lightbox thumbnail navigation or to set an image if you are linking out to a video. Will default to the "Src" image if nothing is set.', '__x__' ),
              'type'        => 'attach_image',
              'holder'      => 'div'
            ),
            array(
      ...
      vc_map(
        array(
          ...
          'icon'            => 'icon-list',
          'category'        => __( 'Typography', '__x__' ),
          'description'     => __( 'Include an icon list in the content', '__x__' ),
      ...
      vc_map(
        array(
          ...
          'icon'            => 'icon-list-item',
          'category'        => __( 'Typography', '__x__' ),
          'description'     => __( 'Include an icon list item in the icon list', '__x__' ),
      ...
      //     'icon'        => 'info',
      //     'category'    => __( 'Information', '__x__' ),
      //     'description' => __( 'Include a popover or tooltip in the content', '__x__' ),
      //     'params'      => array(
      //       array(
      //         'param_name'  => 'content',
      //         'heading'     => __( 'Text', '__x__' ),
      ...
      //         'param_name'  => 'href',
      //         'heading'     => __( 'Href', '__x__' ),
      //         'description' => __( 'Enter in the URL to link to.', '__x__' ),
      //         'type'        => 'textfield',
      //         'holder'      => 'div'
      //       ),
      //       array(
      //         'param_name'  => 'title',
      //         'heading'     => __( 'Title', '__x__' ),
      //         'description' => __( 'Enter in the title to use', '__x__' ),
      //         'type'        => 'textfield',
      //         'holder'      => 'div'
      //       ),
      //       array(
      //         'param_name'  => 'target',
      //         'heading'     => __( 'Target', '__x__' ),
      //         'description' => __( 'Select to open the link in a new window.', '__x__' ),
      //         'type'        => 'checkbox',
      //         'holder'      => 'div',
      //         'value'       => array(
      //           '' => 'blank'
      ...
      //         'param_name'  => 'info',
      //         'heading'     => __( 'Info', '__x__' ),
      //         'description' => __( 'Select whether or not to use a popover or tooltip.', '__x__' ),
      //         'type'        => 'dropdown',
      //         'holder'      => 'div',
      //         'value'       => array(
      //           'Popover' => 'popover',
      ...
      vc_map(
        array(
          ...
          'icon'        => 'columnize',
          'category'    => __( 'Content', '__x__' ),
          'description' => __( 'Split the text into multiple columns', '__x__' ),
          'params'      => array(
            array(
              'param_name'  => 'content',
              'heading'     => __( 'Text', '__x__' ),
      ...
      vc_map(
        array(
          ...
          'icon'        => 'x-video-player',
          'category'    => __( 'Media', '__x__' ),
          'description' => __( 'Include responsive video into the content', '__x__' ),
          'params'      => array(
            array(
              'param_name'  => 'type',
              'heading'     => __( 'Aspect Ratio', '__x__' ),
              'description' => __( 'Select the aspect ratio.', '__x__' ),
              'type'        => 'dropdown',
              'holder'      => 'div',
              'value'       => array(
                '16:9' => '16:9',
            ...
            array(
              ...
              'description' => __( 'Include and .m4v version of the video.', '__x__' ),
              'type'        => 'textfield',
              'holder'      => 'div'
            ),
            array(
              ...
              'description' => __( 'Include and .ogv version of the video for additional native browser support.', '__x__' ),
              'type'        => 'textfield',
              'holder'      => 'div'
            ),
            array(
              ...
              'description' => __( 'Include a poster image for the self-hosted video.', '__x__' ),
              'type'        => 'attach_image',
              'holder'      => 'div'
            ),
            array(
              ...
              'description' => __( 'Select to hide the controls on the self-hosted video.', '__x__' ),
              'type'        => 'checkbox',
              'holder'      => 'div',
              'value'       => array(
                '' => 'true'
            ...
            array(
              ...
              'description' => __( 'Select to automatically play the self-hosted video.', '__x__' ),
              'type'        => 'checkbox',
              'holder'      => 'div',
              'value'       => array(
                '' => 'true'
      ...
      vc_map(
        array(
          ...
          'icon'            => 'accordion',
          'category'        => __( 'Content', '__x__' ),
          'description'     => __( 'Include an accordion into the content', '__x__' ),
      ...
      vc_map(
        array(
          ...
          'icon'            => 'accordion-item',
          'category'        => __( 'Content', '__x__' ),
          'description'     => __( 'Include an accordion item in the accordion', '__x__' ),
          ...
          'params'          => array(
            ...
            array(
              'param_name'  => 'title',
              'heading'     => __( 'Title', '__x__' ),
              'description' => __( 'Include a title for the accordion item.', '__x__' ),
              'type'        => 'textfield',
              'holder'      => 'div'
            ),
            array(
              ...
              'description' => __( 'Select for the accordion item to be open by default.', '__x__' ),
              'type'        => 'checkbox',
              'holder'      => 'div',
              'value'       => array(
                '' => 'true'
      ...
      vc_map(
        array(
          ...
          'icon'            => 'tab-nav',
          'category'        => __( 'Content', '__x__' ),
          'description'     => __( 'Include a tab nav into the content', '__x__' ),
          ...
          'params'          => array(
            array(
              ...
              'description' => __( 'If the tab nav is on top, select how many tab nav items you want per row.', '__x__' ),
              'type'        => 'dropdown',
              'holder'      => 'div',
              'value'       => array(
                'Two'   => 'two-up',
            ...
            array(
              ...
              'description' => __( 'Select the position of the tab nav.', '__x__' ),
              'type'        => 'dropdown',
              'holder'      => 'div',
              'value'       => array(
                'None'  => 'none',
      ...
      vc_map(
        array(
          ...
          'icon'            => 'tab-nav-item',
          'category'        => __( 'Content', '__x__' ),
          'description'     => __( 'Include a tab nav item into the tab nav', '__x__' ),
          ...
          'params'          => array(
            array(
              'param_name'  => 'title',
              'heading'     => __( 'Title', '__x__' ),
              'description' => __( 'Include a title for the tab nav item.', '__x__' ),
              'type'        => 'textfield',
              'holder'      => 'div'
            ),
            array(
      ...
      vc_map(
        array(
          ...
          'icon'            => 'tabs',
          'category'        => __( 'Content', '__x__' ),
          'description'     => __( 'Include a tabs container after the tab nav', '__x__' ),
      ...
      vc_map(
        array(
          ...
          'icon'            => 'tab',
          'category'        => __( 'Content', '__x__' ),
          'description'     => __( 'Include a tab into the tabs container', '__x__' ),
        ...
        array(
          ...
          'params'          => array(
            array(
              ...
              'description' => __( 'Select how to hide or show the content.', '__x__' ),
              'type'        => 'dropdown',
              'holder'      => 'div',
              'value'       => array(
      ...
      vc_map(
        array(
          ...
          'icon'            => 'slider',
          'category'        => __( 'Media', '__x__' ),
          'description'     => __( 'Include a slider in the content', '__x__' ),
          ...
          'params'          => array(
            array(
              ...
              'description' => __( 'Select the slider animation.', '__x__' ),
              'type'        => 'dropdown',
              'holder'      => 'div',
              'value'       => array(
                'Slide' => 'slide',
            ...
            array(
              ...
              'description' => __( 'Select for the slides to advance automatically.', '__x__' ),
              'type'        => 'checkbox',
              'holder'      => 'div',
              'value'       => array(
                '' => 'true'
            ...
            array(
              ...
              'description' => __( 'Select to randomly display the slides each time the page loads.', '__x__' ),
              'type'        => 'checkbox',
              'holder'      => 'div',
              'value'       => array(
                '' => 'true'
            ...
            array(
              'param_name'  => 'no_container',
              'heading'     => __( 'No Container', '__x__' ),
              'description' => __( 'Select to remove the container from the slider.', '__x__' ),
              'type'        => 'checkbox',
              'holder'      => 'div',
              'value'       => array(
                '' => 'true'
      ...
      vc_map(
        array(
          ...
          'icon'            => 'slide',
          'category'        => __( 'Media', '__x__' ),
          'description'     => __( 'Include a slide into the slider', '__x__' ),
      ...
      vc_map(
        array(
          ...
          'description' => __( 'Display the most recent posts', '__x__' ),
          'params'      => array(
            array(
              'param_name'  => 'type',
              'heading'     => __( 'Post Type', '__x__' ),
              'description' => __( 'Choose between standard posts or app posts.', '__x__' ),
              'type'        => 'dropdown',
              'holder'      => 'div',
              'value'       => array(
                'Posts'     => 'post',
            ...
            array(
              ...
              'description' => __( 'Enter a number to offset initial starting post of the recent posts.', '__x__' ),
              'type'        => 'textfield',
              'holder'      => 'div'
            ),
            array(
              ...
              'description' => __( 'To filter the posts by category, enter in the slug of the desired category. To filter by multiple categories, enter in the slugs separated by a comma.', '__x__' ),
              'type'        => 'textfield',
              'holder'      => 'div'
            ),
            array(
              ...
              'description' => __( 'Select the orientation or the recent posts.', '__x__' ),
              'type'        => 'dropdown',
              'holder'      => 'div',
              'value'       => array(
      ...
      vc_map(
        array(
          ...
          'icon'        => 'x-audio-player',
          'category'    => __( 'Media', '__x__' ),
          'description' => __( 'Place audio files into the content', '__x__' ),
          'params'      => array(
            array(
              'param_name'  => 'mp3',
              'heading'     => __( 'MP3', '__x__' ),
              'description' => __( 'Include and .mp3 version of the audio.', '__x__' ),
              'type'        => 'textfield',
              'holder'      => 'div'
            ),
            array(
              ...
              'description' => __( 'Include and .oga version of the audio for additional native browser support.', '__x__' ),
              'type'        => 'textfield',
              'holder'      => 'div'
            ),
            array(
      ...
      vc_map(
        array(
          ...
          'icon'            => 'pricing-table',
          'category'        => __( 'Marketing', '__x__' ),
          'description'     => __( 'Include a pricing table in the content', '__x__' ),
          ...
          'params'          => array(
            array(
              ...
              'description' => __( 'Select how many columns you want for the pricing table.', '__x__' ),
              'type'        => 'dropdown',
              'holder'      => 'div',
              'value'       => array(
                '1' => '1',
        ...
        array(
          ...
          'params'          => array(
            ...
            array(
              'param_name'  => 'title',
              'heading'     => __( 'Title', '__x__' ),
              'description' => __( 'Include a title for the pricing column.', '__x__' ),
              'type'        => 'textfield',
              'holder'      => 'div'
            ),
            array(
              ...
              'description' => __( 'Select to make this the featured offer.', '__x__' ),
              'type'        => 'checkbox',
              'holder'      => 'div',
              'value'       => array(
                '' => 'true'
            ...
            array(
              ...
              'description' => __( 'Include a sub heading for the featured column.', '__x__' ),
              'type'        => 'textfield',
              'holder'      => 'div'
            ),
            array(
              ...
              'description' => __( 'Enter in the currency symbol to use.', '__x__' ),
              'type'        => 'textfield',
              'holder'      => 'div'
            ),
            array(
      ...
      vc_map(
        array(
          ...
          'icon'        => 'callout',
          'category'    => __( 'Marketing', '__x__' ),
          'description' => __( 'Include a marketing callout into the content', '__x__' ),
          'params'      => array(
            array(
              'param_name'  => 'type',
              'heading'     => __( 'Alignment', '__x__' ),
              'description' => __( 'Select the alignment for the callout.', '__x__' ),
              'type'        => 'dropdown',
              'holder'      => 'div',
              'value'       => array(
                'Left'   => 'left',
            ...
            array(
              'param_name'  => 'title',
              'heading'     => __( 'Title', '__x__' ),
              'description' => __( 'Enter the title for the callout.', '__x__' ),
              'type'        => 'textfield',
              'holder'      => 'div'
            ),
            array(
              ...
              'description' => __( 'Enter the message for the callout.', '__x__' ),
              'type'        => 'textarea',
              'holder'      => 'div'
            ),
            array(
              ...
              'description' => __( 'Enter the text for the callout button.', '__x__' ),
              'type'        => 'textfield',
              'holder'      => 'div'
            ),
            array(
            ...
            array(
              'param_name'  => 'href',
              'heading'     => __( 'Href', '__x__' ),
              'description' => __( 'Enter in the URL for the callout button to link to.', '__x__' ),
              'type'        => 'textfield',
              'holder'      => 'div'
            ),
            array(
              'param_name'  => 'target',
              'heading'     => __( 'Target', '__x__' ),
              'description' => __( 'Select to open the callout link button in a new window.', '__x__' ),
              'type'        => 'checkbox',
              'holder'      => 'div',
              'value'       => array(
                '' => 'blank'
      ...
      vc_map(
        array(
          ...
          'icon'        => 'promo',
          'category'    => __( 'Marketing', '__x__' ),
          'description' => __( 'Include a marketing promo in the content', '__x__' ),
          'params'      => array(
            array(
              'param_name'  => 'content',
              'heading'     => __( 'Text', '__x__' ),
            ...
            array(
              ...
              'description' => __( 'Include an image for the promo element.', '__x__' ),
              'type'        => 'attach_image',
              'holder'      => 'div'
            ),
            array(
              'param_name'  => 'alt',
              'heading'     => __( 'Alt', '__x__' ),
              'description' => __( 'Enter in the alt text for the promo image.', '__x__' ),
              'type'        => 'textfield',
              'holder'      => 'div'
            ),
            array(
        ...
        array(
          ...
          'params'      => array(
            array(
              ...
              'description' => __( 'Enter in the selector for the images (e.g. if the class is "lightbox-img" enter ".lightbox-img"). Set to ".x-img-link" to automatically setup a lightbox for all linked [image] shortcodes on the page.', '__x__' ),
              'type'        => 'textfield',
              'holder'      => 'div',
              'value'       => '.x-img-link'
            ),
            ...
            array(
              'param_name'  => 'orientation',
              'heading'     => __( 'Orientation', '__x__' ),
              'description' => __( 'Select the orientation of the lightbox.', '__x__' ),
              'type'        => 'dropdown',
              'holder'      => 'div',
              'value'       => array(
                'Horizontal' => 'horizontal',
        ...
        array(
          ...
          'params'      => array(
            ...
            array(
              'param_name'  => 'title',
              'heading'     => __( 'Title', '__x__' ),
              'description' => __( 'Enter in a title for the author information.', '__x__' ),
              'type'        => 'textfield',
              'holder'      => 'div',
      ...
      vc_map(
        array(
          ...
          'icon'        => 'prompt',
          'category'    => __( 'Marketing', '__x__' ),
          'description' => __( 'Include a marketing prompt into the content', '__x__' ),
          'params'      => array(
            array(
              'param_name'  => 'type',
              'heading'     => __( 'Alignment', '__x__' ),
              'description' => __( 'Select the alignment of the prompt.', '__x__' ),
              'type'        => 'dropdown',
              'holder'      => 'div',
              'value'       => array(
                'Left'  => 'left',
            ...
            array(
              'param_name'  => 'title',
              'heading'     => __( 'Title', '__x__' ),
              'description' => __( 'Enter the title for the prompt.', '__x__' ),
              'type'        => 'textfield',
              'holder'      => 'div'
            ),
            array(
              'param_name'  => 'message',
              'heading'     => __( 'Message', '__x__' ),
              'description' => __( 'Enter the message for the prompt.', '__x__' ),
              'type'        => 'textarea',
              'holder'      => 'div'
            ),
            array(
              'param_name'  => 'button_text',
              'heading'     => __( 'Button Text', '__x__' ),
              'description' => __( 'Enter the text for the prompt button.', '__x__' ),
              'type'        => 'textfield',
              'holder'      => 'div'
            ),
            array(
            ...
            array(
              'param_name'  => 'href',
              'heading'     => __( 'Href', '__x__' ),
              'description' => __( 'Enter in the URL for the prompt button to link to.', '__x__' ),
              'type'        => 'textfield',
              'holder'      => 'div'
            ),
            array(
              'param_name'  => 'target',
              'heading'     => __( 'Target', '__x__' ),
              'description' => __( 'Select to open the prompt button link in a new window.', '__x__' ),
              'type'        => 'checkbox',
              'holder'      => 'div',
              'value'       => array(
                '' => 'blank'
      ...
      vc_map(
        array(
          ...
          'icon'        => 'share',
          'category'    => __( 'Social', '__x__' ),
          'description' => __( 'Include social sharing into the content', '__x__' ),
          'params'      => array(
            array(
              'param_name'  => 'title',
              'heading'     => __( 'Title', '__x__' ),
              'description' => __( 'Enter in a title for the social links.', '__x__' ),
              'type'        => 'textfield',
              'holder'      => 'div',
      ...
      vc_map(
        array(
          ...
          'icon'            => 'toc',
          'category'        => __( 'Information', '__x__' ),
          'description'     => __( 'Include a table of contents in the content', '__x__' ),
          ...
          'params'          => array(
            ...
            array(
              'param_name'  => 'type',
              'heading'     => __( 'Alignment', '__x__' ),
              'description' => __( 'Select the alignment of the table of contents.', '__x__' ),
              'type'        => 'dropdown',
              'holder'      => 'div',
              'value'       => array(
                'Left'      => 'left',
            ...
            array(
              'param_name'  => 'columns',
              'heading'     => __( 'Columns', '__x__' ),
              'description' => __( 'Select a column count for the links if you have chosen "Fullwidth" as the alignment.', '__x__' ),
              'type'        => 'dropdown',
              'holder'      => 'div',
              'value'       => array(
                '1' => '1',
      ...
      vc_map(
        array(
          ...
          'category'    => __( 'Typography', '__x__' ),
          'description' => __( 'Include a custom headline in the content', '__x__' ),
          'params'      => array(
            array(
              'param_name'  => 'content',
              'heading'     => __( 'Text', '__x__' ),
            ...
            array(
              ...
              'description' => __( 'Select which level to use for the heading (e.g. h2).', '__x__' ),
              'type'        => 'dropdown',
              'holder'      => 'div',
              'value'       => array(
                'h1' => 'h1',
            ...
            array(
              ...
              'description' => __( 'Select which level the heading should look like (e.g. h3).', '__x__' ),
              'type'        => 'dropdown',
              'holder'      => 'div',
              'value'       => array(
                'h1' => 'h1',
      ...
      //     'icon'        => 'social',
      //     'category'    => __( 'Typography', '__x__' ),
      //     'description' => __( 'Include a Foundation Social icon in the content', '__x__' ),
      //     'params'      => array(
      //       array(
      //         'param_name'  => 'type',
      //         'heading'     => __( 'Type', '__x__' ),
      ...
      vc_map(
        array(
          ...
          'icon'            => 'container',
          'category'        => __( 'Structure', '__x__' ),
          'description'     => __( 'Include a container in the content', '__x__' ),
      ...
      vc_map(
        array(
          ...
          'category'    => __( 'Typography', '__x__' ),
          'description' => __( 'Include a feature headline in the content', '__x__' ),
          'params'      => array(
            array(
              'param_name'  => 'content',
              'heading'     => __( 'Text', '__x__' ),
            ...
            array(
              ...
              'description' => __( 'Select the icon to use with the feature headline.', '__x__' ),
              'type'        => 'dropdown',
              'holder'      => 'div',
              'value'       => $param_icon_value
            ),
      ...
      vc_map(
        array(
          ...
          'category'    => __( 'Typography', '__x__' ),
          'description' => __( 'Include responsive text in the content', '__x__' ),
          'params'      => array(
            array(
              'param_name'  => 'selector',
              'heading'     => __( 'Selector', '__x__' ),
              'description' => __( 'Enter in the selector for the responsive text (e.g. if the class is "h-responsive" enter ".h-responsive").', '__x__' ),
              'type'        => 'textfield',
              'holder'      => 'div',
            ),
            array(
              ...
              'description' => __( 'Enter the compression for the responsive text (adjust up and down to desired level in small increments).', '__x__' ),
              'type'        => 'textfield',
              'holder'      => 'div',
              'value'       => '1.0'
            ),
            array(
              ...
              'description' => __( 'Enter the minimum size of the responsive text.', '__x__' ),
              'type'        => 'textfield',
              'holder'      => 'div'
            ),
            array(
              ...
              'description' => __( 'Enter the maximum size of the responsive text.', '__x__' ),
              'type'        => 'textfield',
              'holder'      => 'div'
            )
          )
      ...
      vc_map(
        array(
          ...
          'icon'        => 'search',
          'category'    => __( 'Content', '__x__' ),
          'description' => __( 'Include a search field in the content', '__x__' ),
          'params'      => array(
            array(
              'param_name'  => 'id',
              'heading'     => __( 'ID', '__x__' ),
      ...
      vc_map(
        array(
          ...
          'icon'        => 'text-output',
          'category'    => __( 'Content', '__x__' ),
          'description' => __( 'Include a block of text in the content', '__x__' ),
          'params'      => array(
            array(
              'param_name'  => 'content',
              'heading'     => __( 'Text', '__x__' ),
  ...
  if ( ! function_exists( 'x_visual_composer_update_existing_shortcodes' ) ) {
    ...
    function x_visual_composer_update_existing_shortcodes() {
      ...
      vc_map_update( 'vc_row', array(
        ...
        'icon'        => 'content-band',
        'category'    => __( 'Structure', '__x__' ),
        'description' => __( 'Place and structure the shortcodes inside of a row', '__x__' )
      ) );
      ...
      vc_add_param( 'vc_row', array(
        ...
        'description' => __( 'Select whether or not to display a border on the content band.', '__x__' ),
        'type'        => 'dropdown',
        'holder'      => 'div',
        'value'       => array(
          'None'       => 'none',
      ...
      vc_add_param( 'vc_row', array(
        ...
        'description' => __( 'Select the background color of the content band (leave blank for "transparent").', '__x__' ),
        'type'        => 'colorpicker',
        'holder'      => 'div'
      ) );
      ...
      vc_add_param( 'vc_row', array(
        ...
        'description' => __( 'Upload a background pattern to the content band.', '__x__' ),
        'type'        => 'attach_image',
        'holder'      => 'div'
      ) );
      ...
      vc_add_param( 'vc_row', array(
        ...
        'description' => __( 'Upload a background image to the content band (this will overwrite the Background Pattern).', '__x__' ),
        'type'        => 'attach_image',
        'holder'      => 'div'
      ) );
      ...
      vc_add_param( 'vc_row', array(
        ...
        'description' => __( 'Include the path to the background video (this will overwrite both the Background Pattern and Background Image).', '__x__' ),
        'type'        => 'textfield',
        'holder'      => 'div'
      ) );
      ...
      vc_add_param( 'vc_row', array(
        ...
        'description' => __( 'Include a poster image for the background video on mobile devices.', '__x__' ),
        'type'        => 'attach_image',
        'holder'      => 'div'
      ) );
      ...
      vc_add_param( 'vc_column', array(
        ...
        'description' => __( 'Select the type of fade animation to use.', '__x__' ),
        'type'        => 'dropdown',
        'holder'      => 'div',
        'value'       => array(
          'In'             => 'in',
      ...
      vc_add_param( 'vc_column', array(
        ...
        'description' => __( 'Set how large of an offset for the fade animation.', '__x__' ),
        'type'        => 'textfield',
        'holder'      => 'div',
        'value'       => '45px'
      ) );
      ...
      vc_map_update( 'vc_widget_sidebar', array(
        ...
        'icon'        => 'widget-area',
        'category'    => __( 'Content', '__x__' ),
        'description' => __( 'Place one of the widget areas into the content', '__x__' )
      ) );
      ...
      vc_map_update( 'vc_raw_html', array(
        ...
        'icon'        => 'raw-html',
        'category'    => __( 'Content', '__x__' ),
        'description' => __( 'Output raw HTML code on the page', '__x__' )
      ) );
      ...
      vc_map_update( 'vc_raw_js', array(
        ...
        'icon'        => 'raw-js',
        'category'    => __( 'Content', '__x__' ),
        'description' => __( 'Output raw JavaScript code on the page', '__x__' )
      ) );
      ...
      if ( X_REVOLUTION_SLIDER_IS_ACTIVE ) :
        ...
        vc_map_update( 'rev_slider_vc', array(
          ...
          'icon'        => 'revslider',
          'category'    => __( 'Media', '__x__' ),
          'description' => __( 'Place a Slider Revolution slider into the content', '__x__' )
        ) );
      ...
      if ( X_CONTACT_FORM_7_IS_ACTIVE ) :
        ...
        vc_map_update( 'contact-form-7', array(
          ...
          'icon'        => 'contact-form-7',
          'category'    => __( 'Social', '__x__' ),
          'description' => __( 'Place one of the contact forms into the content', '__x__' )
        ) );
      ...
      if ( X_GRAVITY_FORMS_IS_ACTIVE ) :
        ...
        vc_map(
          array(
            ...
            'icon'        => 'gravity-form',
            'category'    => __( 'Social', '__x__' ),
            'description' => __( 'Place one of the Gravity Forms into the content', '__x__' ),
            'params'      => array(
              array(
                'param_name'  => 'id',
                'heading'     => 'Form',
              ...
              array(
                ...
                'description' => __( 'Select to disable the title of the form.', '__x__' ),
                'type'        => 'checkbox',
                'holder'      => 'div',
                'value'       => array(
                  '' => 'false'
              ...
              array(
                ...
                'description' => __( 'Select to disable the description of the form.', '__x__' ),
                'type'        => 'checkbox',
                'holder'      => 'div',
                'value'       => array(
                  '' => 'false'
              ...
              array(
                ...
                'description' => __( 'Select to enable the AJAX functionality of the form.', '__x__' ),
                'type'        => 'checkbox',
                'holder'      => 'div',
                'value'       => array(
                  '' => 'true'
...
if ( X_VISUAL_COMOPSER_IS_ACTIVE ) {
  if ( ! function_exists( 'x_visual_composer_overwrite_layout_error_message' ) ) {
    ...
    function x_visual_composer_overwrite_layout_error_message() {
      $message = '<div class="messagebox_text"><p>' . __( 'The layout you are trying to use on this page does not conform to the LeanStack Visual Composer&#39;s layout guidelines. For serious help with help with issue, email us at <a href="mailto:leanstack@lean-labs.com>leanstack@lean-labs.com</a>.', '__x__' ) . '</p></div>';
