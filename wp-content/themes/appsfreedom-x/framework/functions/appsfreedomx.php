...
// =============================================================================
// FUNCTIONS/APPSFREEDOMX.PHP
// -----------------------------------------------------------------------------
// appsfreedomx (LeanStack) specific functions.
// =============================================================================
...
if ( ! function_exists( 'x_appsfreedomx_entry_meta' ) ) :
  function x_appsfreedomx_entry_meta() {
...
if ( ! function_exists( 'x_appsfreedomx_portfolio_tags' ) ) :
  function x_appsfreedomx_portfolio_tags() {
...
if ( ! function_exists( 'x_appsfreedomx_comment' ) ) :
  function x_appsfreedomx_comment( $comment, $args, $depth ) {
