      ...
      menu  : [
        ...
        { text : 'Social',
          menu : [
            ...
            { text : 'Recent Posts',      onclick: function() { editor.insertContent('[recent_posts type="post, apps" category="" count="1, 2, 3, 4" offset="1, 2, 3..." orientation="horizontal, vertical" no_image="true" fade="true"]'); } },
