    ...
    render : function(ed, title, id) {
      ed.add({
        ...
        onclick: function () {
          ...
          if(id === 'recent-posts') {
            tinyMCE.activeEditor.selection.setContent('[recent_posts type="post, apps" category="" count="1, 2, 3, 4" offset="1, 2, 3..." orientation="horizontal, vertical" no_image="true" fade="true"]');
          }
