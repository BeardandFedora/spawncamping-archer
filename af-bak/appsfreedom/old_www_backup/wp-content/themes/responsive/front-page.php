...
if ( 'posts' == get_option( 'show_on_front' ) && $responsive_options['front_page'] != 1 ) {
	...
	<div id="featured" class="grid col-940" style="background:url('/wp-content/uploads/2013/07/bg-mobile-home.jpg') no-repeat">
...
?>
			...
			<?php if ($responsive_options['cta_button'] == 0): ?>  
				...
				<div class="call-to-action">
					...
					<a href="/apps" class="blue button">
						<?php 
						if( isset( $responsive_options['cta_text'] ) && $db && $empty )
							echo $responsive_options['cta_text']; 
						else
							_e('Learn More','responsive');
						?>
					</a>
