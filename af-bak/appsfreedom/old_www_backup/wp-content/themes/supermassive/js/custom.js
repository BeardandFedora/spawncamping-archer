...
jQuery(document).ready(function(){
	...
	jQuery('.sc-image, .post-thumbnail, .portfolio-thumbnail, .slide, div.gallery-item .gallery-icon').hover(
		function() {
			...
			jQuery(this).find("a[rel^='prettyPhoto'] .image, a[rel^='prettyPhoto'] .reflected, a[rel^='prettyPhoto'] .slider-image, .lightbox.caption-overlay, a[rel^='prettyPhoto'] .attachment-thumbnail").stop().fadeTo(750, 0.5);
		},
		function() {
			jQuery(this).find('.hover-image, .hover-video').stop().fadeTo(750, 0);
			jQuery(this).find("a[rel^='prettyPhoto'] .image, a[rel^='prettyPhoto'] .reflected, a[rel^='prettyPhoto'] .slider-image, .lightbox.caption-overlay, a[rel^='prettyPhoto'] .attachment-thumbnail").stop().fadeTo(750, 1);
		})
