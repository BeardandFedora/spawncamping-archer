		...
		?>
			...
			<div class="post<?php if($theme_preload == "1") { ?> preload<?php } ?>">
				...
				<div class="post-text">
					...
					<h2 class="job-position"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2>
					
				
					

					
					<p><?php the_excerpt(); ?> <?php if($theme_read_more == "0") { ?><a href="<?php the_permalink(); ?>"><?php echo "<span class=\"position-details\">:: View Details and Apply ::</span>"; ?></a><?php } ?></p>	
