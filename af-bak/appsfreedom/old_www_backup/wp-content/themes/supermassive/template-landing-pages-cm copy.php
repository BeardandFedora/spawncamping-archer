...
/*
Template Name: Landing Pages with Campaign Monitor Form
*/ 
...
<body>
  ...
  <p style="padding-right:20px;"><?php $formfooter="formfooter"; echo get_post_meta($post->ID, $formfooter, true); ?></p>     
	...
	<div id="footer">
        ...
        <div class="wrap">
            ...
            <!-- start of copyright -->
            <div class="copyright">
                 <p>&copy;<?php the_time('Y') ?> appsFreedom. All rights reserved.</p>
            </div>
            <!-- end of copyright -->
