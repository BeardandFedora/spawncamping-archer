...
function update_notifier() { 
	...
	<div class="wrap">
        ...
        <div id="instructions" style="max-width: 800px;">
			...
			<p>1. Upload the <code>supermassive</code> folder to the <code>/wp-content/themes/</code> directory in place of the old one via an FTP program.</p>
			
			<p>2. Rename the supermassive.zip file e.g. <code>supermassive-new.zip</code>. Now go to your WordPress Admin Panel, select Appearance > Themes > Install Themes > Upload and upload the zip file.</p>
			
			<p>If you have made code changes to your theme files view the <a href="http://ghostpool.com/help/supermassive/changelog.html" target="_blank">changelog</a> for a list of files changed.</p>
...
function get_latest_theme_version($interval) {
	...
	$notifier_file_url = 'http://ghostpool.com/help/supermassive/notifier.xml';
	
	$db_cache_field = 'supermassive-notifier-cache';
	$db_cache_field_last_updated = 'supermassive-notifier-last-updated';
