...
array(	"name" => "Category Settings",
		...
		array(  
		"name" => "Breadcrumbs",
        "desc" => "Choose whether to display breadcrumb navigation for category, archive, tag pages etc.",
		...
		array(  
		"name" => "Read More Link",
        "desc" => "Choose whether to display the read more links for category, archive, tag pages etc.",
...
<ul id="theme-option-links">
	<li><a href="http://www.ghostpool.com/help/<?php echo $dirname; ?>/changelog.html" target="_blank">Theme Updates</a></li>
