...
function ghostpool_slide_meta_boxes() {
	...
	'custom_slide_settings' => array('name' => 'custom_slide_settings', 'type' => 'open', 'title' => __('Custom Slide Settings', 'ghostpool'), 'desc' => 'You can only use these settings if the Image URL and Video URL fields above are left empty.'),
