...
function insertghostpoolLink() {
	...
	var style = document.getElementById('style_panel');
		...
		if (styleid != 0 && styleid == 'image') {
			tagtext = "["+ styleid + " url=\"#\" width=\"#\" height=\"#\" align=\"alignnone\" link=\"\" lightbox=\"none\" alt=\"\" title=\"\" shadow=\"none\" reflection=\"none\" zoom=\"0\" preload=\"false\" /] ";	
		}
		...
		if (styleid != 0 && styleid == 'slider') {
			tagtext = "["+ styleid + " name=\"#\" cat=\"\" slides=\"-1\" effect=\"fade\" width=\"#\" height=\"#\" align=\"none\" nav=\"1\" arrows=\"true\" timeout=\"6\" shadow=\"none\" /] ";	
		}
		
     	if (styleid != 0 && styleid == 'portfolio') {
			tagtext = "["+ styleid + " type=\"three-col\" cats=\"\" col_height=\"\" image_width=\"\" image_height=\"\" per_page=\"9\" orderby=\"date\" order=\"desc\" excerpt_length=\"50\" title=\"true\" title_link=\"true\" read_more=\"true\" shadow=\"none\" reflection=\"none\" pagination=\"true\" preload=\"false\" /] ";	
		}
		...
		if (styleid != 0 && styleid == 'blog') {
			tagtext = "["+ styleid + " images=\"true\" cats=\"\" image_width=\"640\" image_height=\"250\" per_page=\"9\" orderby=\"date\" order=\"desc\" offset=\"0\" excerpt_length=\"50\" meta=\"true\" full_content=\"false\" title=\"true\" read_more=\"true\" shadow=\"none\" reflection=\"none\" divider=\"curved\" pagination=\"true\" preload=\"false\" wrap=\"false\" /] ";	
		}		
