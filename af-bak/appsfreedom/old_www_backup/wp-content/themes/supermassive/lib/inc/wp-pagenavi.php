			...
			switch(intval($pagenavi_options['style'])) {
				case 1:
					...
					if ($start_page >= 2 && $pages_to_show < $max_page) {
						...
						echo '<a href="'.clean_url(get_pagenum_link()).'" class="first" title="'.$first_page_text.'">&#8249;</a>';
					...
					if ($end_page < $max_page) {
						...
						echo '<a href="'.clean_url(get_pagenum_link($max_page)).'" class="last" title="'.$last_page_text.'">&#8250;</a>';
					}
					break;
				case 2;
