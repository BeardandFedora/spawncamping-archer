...
<html lang="en">
<head>
  <title>AppsFreedom Platform Tour</title>
      ...
      <div class="container">
        <div class="carousel-inner">
          ...
          <div class="item">
            <div class="row">
              <div class="col-md-5">
                <img src="/img/tour/slides/3_integrate/image_04.png" class="img-responsive center-block" alt="Backend-as-a-Service (BaaS)">
              </div>
              <div class="col-md-7">
          ...
          <div class="item">
            <div class="row">
              ...
              <div class="col-md-7">
                ...
                <p>Deploy using a corporate <strong><a href="/apps" title="app library">app library</a></strong> or leverage your MDM deployment capabilities.</p>
              </div>
            </div>
          </div>
          <div class="item">
