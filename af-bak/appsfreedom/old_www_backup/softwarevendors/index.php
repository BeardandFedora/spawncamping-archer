...
<html lang="en">
<head>
	<title>AppsFreedom Software Vendors</title>
	<?php include('../includes/head.php'); ?>
</head>
<body class="landing">
	<?php include('../includes/nav_sub.php'); ?>
	...
	<section class="hero super-hero bg-md-blue">
		<div class="container">
			...
			<div class="col-md-5 hidden-sm hidden-xs bg-image">
				<img src="/img/george.png" class="img-responsive" alt="" />
			</div>
		</div>
		<div class="bg-dark-blue">
			<div class="container">
				<div class="col-md-12">
					<img src="/img/landing/banner.png" class="banner"/>
				</div>
			</div>
		</div>
	</section>
...
<p>Download our ebook made especially for software vendors, <strong>"The Top 10 Reasons SaaS Vendors Choose AppsFreedom"</strong>, to find out how <strong> we empower software companies.</strong></p>
	...
	<script src="../js/bootstrap.jansy.min.js"></script>
</body>
</html>