...
function x_add_page_meta_boxes() {
  ...
  $meta_box = array(
    ...
    'title'       => __( 'App Settings', '__x__' ),
    'description' => __( 'Here you will find various options you can use to setup your app.', '__x__' ),
    'page'        => 'page',
    'context'     => 'normal',
    'priority'    => 'high',
    'fields'      => array(
      ...
      array(
        ...
        'desc'    => __( 'Select how many columns you would like to display for your app.', '__x__' ),
      ...
      array(
        ...
        'desc'    => __( 'Select the layout you would like to display for your app. The "Use Global Content Layout" option allows you to keep your sidebar if you have already selected "Content Left, Sidebar Right" or "Sidebar Left, Content Right" for your "Content Layout" in the Customizer.', '__x__' ),
      ...
      array(
        ...
        'desc' => __( 'Select how many posts you would like to display per page for your app.', '__x__' ),
      ...
      array(
        ...
        'desc' => __( 'Turning off the portfolio filters will remove the ability to sort app items by category.', '__x__' ),
  ...
  $meta_box = array(
    ...
    'fields'      => array(
      array(
        ...
        'desc' => __( 'Insert your link URL, e.g. http://www.appsfreedom.com.', '__x__' ),
        'id'   => '_x_link_url',
        'type' => 'text',
        'std'  => ''
      )
...
function x_add_portfolio_item_meta_boxes() {
  ...
  $meta_box = array(
    ...
    'title'       => __( 'App Item Settings', '__x__' ),
    'description' => __( 'Select the appropriate options for your app item.', '__x__' ),
    'page'        => 'x-portfolio',
    'context'     => 'normal',
    'priority'    => 'high',
    'fields'      => array(
      ...
      array(
        'name' => __( 'Apps Parent', '__x__' ),
        'desc' => __( 'Assign the parent Apps page for this app item. This will be used in various places throughout the theme such as your breadcrumbs. If "Default" is selected then the first page with the "Layout - App" template assigned to it will be used.', '__x__' ),
      ...
      array(
        ...
        'desc'    => __( 'Select which kind of media you want to display for your app. If selecting a "Gallery," simply upload your images to this post and organize them in the order you want them to display.', '__x__' ),
  ...
  $meta_box = array(
    ...
    'title'       => __( 'Video App Item Settings', '__x__' ),
    'description' => __( 'These settings enable you to embed videos into your app items.', '__x__' ),
    'page'        => 'x-portfolio',
    'context'     => 'normal',
    'priority'    => 'high',
    'fields'      => array(
